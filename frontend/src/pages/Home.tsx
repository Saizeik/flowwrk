...
function FeatureCard({
  ...
  return (
    <div
      className={cx(
        "rounded-2xl border border-slate-200/60 bg-white/80 p-5 shadow-sm backdrop-blur-xl",
        "transition hover:-translate-y-0.5 hover:shadow-md"
      )}
    >
      <div className="flex items-start gap-3">
        <div className="rounded-xl bg-blue-600/10 p-2 text-blue-700 ring-1 ring-blue-200/60">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            <Link to="/" className="inline-flex items-center gap-2">
              <BrandLogo linkToHome={false} size="md" variant="lockup" wordmarkClassName="h-14"
  iconClassName="h-16 w-16"/>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 text-slate-900">
        ...
        <div className="pointer-events-none relative">
          <div className="absolute -top-10 -left-10 h-44 w-44 rounded-full bg-blue-500/10 blur-3xl" />
          <div className="absolute top-10 right-0 h-44 w-44 rounded-full bg-violet-500/10 blur-3xl" />
          <div className="absolute bottom-0 left-24 h-44 w-44 rounded-full bg-emerald-500/10 blur-3xl" />
        </div>

        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
          {/* Left */}
          <div className="relative rounded-3xl border border-slate-200/60 bg-white/80 p-6 shadow-sm backdrop-blur-xl sm:p-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/70 bg-white/70 px-3 py-1 text-xs font-semibold text-slate-700">
            ...
            <div className="mt-7 rounded-2xl border border-slate-200/70 bg-slate-50 p-4">
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-3 border-t border-slate-200/60 pt-6 sm:flex-row">
          <div className="text-sm text-slate-500">© {new Date().getFullYear()} Flowwrk</div>
